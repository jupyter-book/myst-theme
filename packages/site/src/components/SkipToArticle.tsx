...
export function SkipToArticle({
  ...
  return (
    <div
      className="myst-skip-to-article fixed top-1 left-1 h-[0px] w-[0px] focus-within:z-40 focus-within:h-auto focus-within:w-auto bg-myst-bg overflow-hidden focus-within:p-2 focus-within:ring-1"
      aria-label="skip to content options"
    >
      {frontmatter && (
        <a
          href={`#${fm}`}
          className="myst-skip-to-link block px-2 py-1 text-myst-text underline"
