...
const themeExtensions = {
  colors: {
    ...
    'myst-link-dark': 'var(--myst-color-link-dark)',
    'myst-link-hover-dark': 'var(--myst-color-link-hover-dark)',
    ...
    'myst-active-dark': 'var(--myst-color-active-dark)',
    ...
    'myst-heading-dark': 'var(--myst-color-heading-dark)',
    'myst-surface': 'var(--myst-color-surface)',
    'myst-surface-border': 'var(--myst-color-surface-border)',
    'myst-surface-border-dark': 'var(--myst-color-surface-border-dark)',
    'myst-surface-text': 'var(--myst-color-surface-text)',
    'myst-surface-dark': 'var(--myst-color-surface-dark)',
    'myst-banner-bg': 'var(--myst-color-banner-bg)',
    'myst-banner-bg-dark': 'var(--myst-color-banner-bg-dark)',
    'myst-surface-text-dark': 'var(--myst-color-surface-text-dark)',
  },
  gridTemplateColumns: {
    'article-sm':
    ...
    DEFAULT: {
      css: {
        ...
        a: {
          ...
          textDecorationColor: 'var(--myst-color-link-dark)',
          '&:hover': {
