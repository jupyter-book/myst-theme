...
function CreativeCommons(
  ...
  function CreativeCommonsWrapper({ className, title }: { className?: string; title?: string }) {
    return (
      <span title={title}>
        <svg
          version="1.1"
  ...
  return CreativeCommonsWrapper;
}

export const CC = CreativeCommons('5.5 -3.5 64 64', { cx: '37.785', cy: '28.501', r: '28.836' }, [
...
export const BY = CreativeCommons('5.5 -3.5 64 64', { cx: '37.785', cy: '28.501', r: '28.836' }, [
...
export function CreativeCommonsBadge({
  ...
  return (
    ...
    >
      ...
      {kind.includes('BY') && (
        <BY className="h-[1.3em] px-1 inline-block" title="Credit must be given to the creator" />
      )}
      {kind.includes('NC') && (
        <NC
          className="h-[1.3em] px-1 inline-block"
