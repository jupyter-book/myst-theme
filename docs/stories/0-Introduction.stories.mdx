...
`@myst-theme` is a set of open-source, community-driven components designed for scientific communication that are designed to work with [myst-tools.org](https://myst-tools.org), which includes a powerful authoring framework that supports blogs, online books, scientific papers, reports and journals articles.
