...
export function TopNav({
  ...
  return (
    <div className="myst-top-nav bg-qutNavy backdrop-blur dark:bg-qutNavy shadow dark:shadow-qutNavy p-3 md:px-8 sticky w-full top-0 z-30 min-h-[60px]">
        ...
        <div className="flex flex-row xl:min-w-[19.5rem] mr-2 sm:mr-7 justify-start items-center shrink-0">
          {
            ...
            >
              <button
                className="myst-top-nav-menu-button flex items-center justify-center border-stone-400 text-stone-800 hover:text-stone-900 w-10 h-10"
                onClick={() => {
                  setOpen(!open);
                }}
              >
