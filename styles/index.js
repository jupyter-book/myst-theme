...
const themeExtensions = {
  colors: {
    ...
    'myst-tip': 'var(--myst-color-tip)',
    'myst-tip-bg': 'var(--myst-color-tip-bg)',
    'myst-tip-text': 'var(--myst-color-tip-text)',
    ...
    'myst-error': 'var(--myst-color-error)',
    'myst-error-bg': 'var(--myst-color-error-bg)',
    'myst-error-text': 'var(--myst-color-error-text)',
    'myst-theorem': 'var(--myst-color-theorem)',
    'myst-theorem-bg': 'var(--myst-color-theorem-bg)',
    'myst-theorem-text': 'var(--myst-color-theorem-text)',
    'myst-example': 'var(--myst-color-example)',
    'myst-example-bg': 'var(--myst-color-example-bg)',
    'myst-example-text': 'var(--myst-color-example-text)',
    'myst-proof': 'var(--myst-color-proof)',
